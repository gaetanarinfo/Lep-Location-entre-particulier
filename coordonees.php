    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-md-9 ms-sm-auto ps-0 pe-4 col-lg-10 page">
                ...
                <div class="mt-4 mb-5">
                    <h4><i class="fa-solid fa-file-pen me-2 text-success"></i>Mes informations personnelles</h4>
                </div>
                                ...
                                <div class="row justify-content-center bloc-form">
                                    ...
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input class="form-control" autocomplete="off" required id="tel" placeholder="Téléphone" type="tel" name="tel" value="<?= $users['tel'] ?>">
                                        </div>

                                        <div class="form-group mb-3">
                                            <label>* Prenom</label>
                                            <input class="form-control" autocomplete="off" required id="prenom" placeholder="Prénom" type="text" name="prenom" value="<?= $users['prenom'] ?>">
                                        </div>
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input class="form-control" style="width: 120px;" autocomplete="off" required id="cp" placeholder="Code postal" type="text" name="cp" value="<?= $users['cp'] ?>">
                                        </div>
                                    ...
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <div class="form-group mb-3">
                                            <label>* Email</label>
                                            <input class="form-control" autocomplete="off" required id="email" placeholder="Adresse email" type="text" name="email" value="<?= $users['email'] ?>">
                                        </div>


                                        <div class="form-group mb-3">
                                            <label>* Nom</label>
                                            <input class="form-control" autocomplete="off" required id="nom" placeholder="Nom" type="text" name="nom" value="<?= $users['nom'] ?>">
                                        </div>

                                        <div class="form-group mb-3">
                                            <label>* Adresse</label>
                                            <input class="form-control" autocomplete="off" required id="adresse" placeholder="Adresse" type="text" name="adresse" value="<?= $users['adresse'] ?>">
                                        </div>

                                        <div class="form-group mb-3">
                                            <label>* Ville</label>
                                            <input class="form-control" autocomplete="off" required id="ville" placeholder="Ville" type="text" name="ville" value="<?= $users['ville'] ?>">
                                        </div>
