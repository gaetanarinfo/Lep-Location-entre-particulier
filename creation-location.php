    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-md-9 ms-sm-auto ps-0 pe-4 col-lg-10 page">
                ...
                <div class="mt-4 mb-5">
                    <h4><i class="fa-solid fa-square-plus me-2 text-success"></i>Créer votre location</h4>
                </div>
                    ...
                    <form id="create">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 bloc-form">
                                <input type="submit" value="Créer votre location" id="button-create" class="btn btn-block bg-gradient btn-info btn-lg text-white">
                            </div>
