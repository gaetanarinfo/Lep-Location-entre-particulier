                        ...
                        <div class="col-md-6 mt-5">
                            ...
                            <div class="row bloc-contact">
                                ...
                                if (!empty($_COOKIE['location_email'])) {
                                    ...
                                    $user_location->execute(['id' => $maison['user_id']]);
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <form id="contact-prop">
                                                ...
                                                <div class="form-group mb-3 form-bloc-email">
                                                    ...
                                                    <input type="hidden" id="location_id" name="location_id" value="<?= $maison['id'] ?>">
                                                    <input type="hidden" id="location_type" name="location_type" value="<?= $maison['type'] ?>">
                                                </div>
