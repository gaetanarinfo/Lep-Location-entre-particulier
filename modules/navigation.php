    ...
    <div class="container px-5">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="dropdown text-start dropdown-user">
                ...
                <a href="#" class="d-block link-light text-decoration-none dropdown-toggle" id="dropdownUser1" data-bs-toggle="dropdown" aria-expanded="false">
                    <span class="rounded-circle">
                        <?php if (!empty($users['avatar'])) { ?>
                            <img src="<?= $users['avatar'] ?>" alt="<?= $users['prenom'] . ' ' . $users['nom'] ?>" class="img-fluid rounded-circle" width="24" height="24">
                        <?php } else { ?>
                ...
                <ul class="dropdown-menu text-small dropdown-menu-dark shadow" aria-labelledby="dropdownUser1">
