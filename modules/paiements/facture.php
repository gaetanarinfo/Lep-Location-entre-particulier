...
$pdf->Cell(0, 6, mb_convert_encoding($users['nom'] . ' ' . $users['prenom'], 'ISO-8859-1', 'UTF-8'), 0, 22, 'R');
$pdf->Cell(0, 6, mb_convert_encoding($users['adresse'], 'ISO-8859-1', 'UTF-8'), 0, 22, 'R');
$pdf->Cell(0, 6, mb_convert_encoding($users['ville'] . ' ' . $users['cp'], 'ISO-8859-1', 'UTF-8'), 0, 22, 'R');
$pdf->Cell(0, 6, mb_convert_encoding($users['pays'], 'ISO-8859-1', 'UTF-8'), 0, 22, 'R');
$pdf->Cell(0, 6, mb_convert_encoding($users['email'], 'ISO-8859-1', 'UTF-8'), 0, 22, 'R');
