...
<main class="flex-shrink-0">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-md-9 ms-sm-auto ps-0 pe-4 col-lg-10 page" id="page">
                ...
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    ...
                    <div class="btn-toolbar mb-2 mb-md-0">
                        ...
                        <div class="btn-group me-2">
                            <button type="button" class="btn btn-sm btn-outline-secondary" id="share">Partager</button>
                        </div>

                        <div class="dropdown dropdown-user">

                            <button type="button" class="btn btn-sm btn-outline-secondary dropdown-toggle" id="dropdownYear" data-bs-toggle="dropdown" aria-expanded="false">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownYear">
                                <li>
                                    <a class="dropdown-item <?= (empty($_GET['year']) or $_GET['year'] == 2023) ? 'disabled' : '' ?>" href="<?= $_GET['url'] . '&year=' . date('Y') ?>"><?= date('Y') ?></a>
                                </li>

                                <?php for ($i = date('Y', strtotime('+1 year')); $i < 2031; $i++) {
                                    if (!empty($_GET['year']) && $_GET['year'] == $i)
                                        echo '<a class="dropdown-item disabled" href="' . $_GET['url'] . '&year=' . $i . '">' . $i . '</a>';
                                    else
                                        echo '<a class="dropdown-item" href="' . $_GET['url'] . '&year=' . $i . '">' . $i . '</a>';
                                } ?>
                            </div>
                            ...
                            <div class="mt-4 col">
                                ...
                                <div>
                                    ...
                                    <ul class="nav nav-tabs">
                                        ...
                                        <li class="nav-item">
                                            <a data-item="1" class="nav-link active nav-1" aria-current="page" href="#" tabindex="0" data-bs-toggle="tooltip" data-bs-placement="top" title="Nombre de fois où le détail de votre location a été consulté."><i class="fa-regular fa-eye me-2"></i>Vues</a>
                                        </li>
                                ...
                                <div class="col-xl-12 col-lg-12 mt-4">
                                    ...
                                    <div class="card shadow mb-4 bloc-stats-1">
                                        ...
                                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                            <h6 class="m-0 font-weight-bold text-success">Nombre de vues sur l'année <?= (!empty($_GET['year'])) ? $_GET['year'] : date('Y') ?></h6>
                                        </div>
                            ...
                            <div class="col">
                                ...
                                <div>
                                    ...
                                    <ul class="nav nav-tabs">
                                        ...
                                        <li class="nav-item">
                                            <a data-item="2" class="nav-link nav-2 active" href="#" tabindex="0" data-bs-toggle="tooltip" data-bs-placement="top" title="Nombre de fois où votre location est apparue dans les résultats de recherche."><i class="fa-solid fa-list-ul me-2"></i>Apparitions</a>
                                        </li>
                                ...
                                <div class="col-xl-12 col-lg-12 mt-4">
                                    ...
                                    <div class="card shadow mb-4 bloc-stats-2">
                                        ...
                                        <!-- Card Header - Dropdown -->
                                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                            <h6 class="m-0 font-weight-bold text-info">Appartitions sur l'année <?= (!empty($_GET['year'])) ? $_GET['year'] : date('Y') ?></h6>
                                        </div>
