        ...
        <?php foreach ($ville_populaire_row as $value) { ?>
            ...
            <div class="col">
                ...
                <a class="text-decoration-none" href="<?= $value['url'] ?>">
                    ...
                    <div class="card card-cover h-100 overflow-hidden text-white bg-white rounded-5 shadow-lg reveal" style="background-image: url('<?= $image_url . 'populaire_ville/' . $value['image'] ?>');">
